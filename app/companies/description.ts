...
function templateSaizen(c: Company): string {
  return `SAIZEN警備保障株式会社は、広島県広島市西区横川を拠点とする交通誘導警備・雑踏警備の専門会社です。「最前線で、地域の安全を守る」という信念のもと、道路工事現場から地域イベントまで、広島の現場に寄り添った警備サービスを提供しています。交通誘導警備は単なる旗振り作業ではありません。現場の状況を瞬時に判断し、ドライバーと歩行者の双方が安心して通行できる環境を作り出す、高度な専門技術が求められる業務です。地域の皆様が「安心」を感じられる警備を、一現場一現場、真剣に追求しています。広島市内を中心に、建設会社・工事会社・イベント主催者の皆様からのご依頼を承っております。お見積もり・ご相談はお気軽にご連絡ください。`
}
